...
def search_google(BRAND,MB):
    ...
    # 検索結果の最初のリンクを取得する
    first_link = driver.find_element(By.XPATH, "//a[contains(text(),{})]".format(MB.lower()) or "//a[contains(text(),{})]".format(MB) )
    first_link = driver.find_element(By.XPATH, "//a[contains(@href,{})]".format(BRAND.lower()))
