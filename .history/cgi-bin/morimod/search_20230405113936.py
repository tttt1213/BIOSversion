...
def search_google(BRAND,MB):
    ...
    search_box.submit()
    # 検索結果の最初のリンクを取得する
    h = driver.find_element(By.XPATH, "//h3[contains(text(),{})]".format(MB.lower()) or "//h3[contains(text(),{})]".format(MB))
    a = h.find_element(By.XPATH, "./*[contains(@href,{})]".format(BRAND.lower()))
