...
def search_google(BRAND,MB):
    ...
    for elem in h:
        print(elem.text)
        parent = elem.find_elements.(By.XPATH,"../a[contains(@href,'{}')]".format(BRAND.lower()))
    ...
    for elem in h:
            print(elem.text)
            print(elem.find_element(By.XPATH,"../a[contains(@href,'{}')]".format(BRAND.lower().get_attribute('href'))))
            
    
/html/body/div[7]/div/div[11]/div/div[2]/div[2]/div/div/div[1]/div/div/div[1]/div/a
/html/body/div[7]/div/div[11]/div/div[2]/div[2]/div/div/div[1]/div/div/div[1]/div/a/h3
