...
filename_elements = driver.find_elements(By.XPATH, "//*[contains(@href, 'SoftwareItemID')]")
...
fileURL_elements = driver.find_elements(By.XPATH, "//*[contains(@href, 'SoftwareItemID')]/..")
print(fileURL_elements.__getattribute_('innerHTML'))
fileURL = fileURL_elements.get_attribute('href')
